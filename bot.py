...
def download_video(url, video_id):
    ...
    "--no-playlist",
    "--cookies", "cookies.txt",
    "--extractor-args", "youtube:player_client=mweb,web,tv;po_token=mweb.gvs+auto,web.gvs+auto",
    "--user-agent", "Mozilla/5.0 (Linux; Android 11) AppleWebKit/537.36 Chrome/124.0.0.0 Mobile Safari/537.36",
    "--sleep-requests", "3",
    "--sleep-interval", "5",
